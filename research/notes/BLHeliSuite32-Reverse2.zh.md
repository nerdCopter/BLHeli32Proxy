...
![](https://img.elmagnifico.tech/static/upload/elmagnifico/3L4fjtRnQhHbCc1.png)
...
![](https://img.elmagnifico.tech/static/upload/elmagnifico/CfnLhwjqMUOHpIJ.png)

这里倒是没什么，但是再往下，可以看到这里的名字基本上全都是对应的参数值！

![](https://img.elmagnifico.tech/static/upload/elmagnifico/Dh24BXzT9dJ3ntM.png)
...
![](https://img.elmagnifico.tech/static/upload/elmagnifico/1HctWPrebpIMaJB.png)
...
![](https://img.elmagnifico.tech/static/upload/elmagnifico/ph4F5uVWXUgIKbm.png)
...
![](https://img.elmagnifico.tech/static/upload/elmagnifico/yLN16TCoRMYdVBb.png)
...
![](https://img.elmagnifico.tech/static/upload/elmagnifico/Y3JrM1ikpVmAoNE.png)

从0x50F6BE4开始，前四个字节描述数据长度，所以这里就是0x0000
0103，也就是259字节数据

这里有一个奇怪的值是从404B48 那个奇怪的地址读出来的

![](https://img.elmagnifico.tech/static/upload/elmagnifico/V7FMc45UHIr1dKx.png)
...
![](https://img.elmagnifico.tech/static/upload/elmagnifico/mtyoDsR8fNIEKF9.png)

目前每次解出来的数据是和反汇编看到的一模一样。最后的输出我将每8字节的前2字节去掉，然后就变成可读的字符串了，和内存的排布是一样的。

![](https://img.elmagnifico.tech/static/upload/elmagnifico/IKRnv1Ab9li4FBz.png)
...
- <a href="/2021/07/07/BLHeliSuite32-Reverse/" data-toggle="tooltip"
  data-placement="top" title="BLHeliSuite32逆向（一）">Previous<br />
  <span>BLHeliSuite32逆向（一）</span></a>
- <a href="/2021/07/20/BLHeliSuite32-Reverse3/" data-toggle="tooltip"
  data-placement="top" title="BLHeliSuite32逆向（三）">Next<br />
  <span>BLHeliSuite32逆向（三）</span></a>
