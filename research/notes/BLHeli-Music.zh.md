...
- **Gen. Length**
  节拍速度,可以理解为播放速度,8表示正常速度，也就是一个音0.5秒，小于8就是更块，大于8就是更慢
- \*\*Gen. Interval
  \*\*就是指音符之间的间隔时间,就是一个音唱完以后等多久唱下一个
...
有效音组只有4个，平常称之为key，就是提高整体音调，平常说5比4高8度，6比7低八度，就是通过音组表示的
...
比如 let it
go，可以看到其中3个电调都是不一样的声音，1和4是主旋律，而2和3都是伴奏
...
音组是基于C也就是1的调，基于他升多少个调，如果升4，也就是C4 =
F调，同理5、6、7
...
- <a href="/2020/06/11/Maya-Shelf-Script/" data-toggle="tooltip"
  data-placement="top" title="Maya 环境自动重配置">Previous<br />
  <span>Maya 环境自动重配置</span></a>
- <a href="/2020/07/13/ttrss-migrate-tencent-cloud/" data-toggle="tooltip"
  data-placement="top" title="TTRSS迁移到腾讯云以及常见问题">Next<br />
  <span>TTRSS迁移到腾讯云以及常见问题</span></a>
